...
public interface ScriptRepository extends JpaRepository<Script, Long> {
  ...
  @Query("SELECT s.hash FROM Script s WHERE s.type IN :types AND s.tx.id BETWEEN :fromTxId AND :toTxId")
  Set<String> findHashByTypeAndTxIn(@Param("fromTxId") Long fromTxId,
                                    @Param("toTxId") Long toTxId,

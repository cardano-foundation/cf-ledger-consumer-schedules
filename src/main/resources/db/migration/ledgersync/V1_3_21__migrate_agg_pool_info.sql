...
(
    ...
    governance_participation_rate double precision,
...
CREATE INDEX IF NOT EXISTS agg_pool_info_pool_id_idx ON agg_pool_info (pool_id);
...
CREATE INDEX IF NOT EXISTS agg_pool_info_governance_participation_rate_idx ON agg_pool_info (delegator_cnt);
CREATE INDEX IF NOT EXISTS agg_pool_info_voting_power ON agg_pool_info (voting_power);

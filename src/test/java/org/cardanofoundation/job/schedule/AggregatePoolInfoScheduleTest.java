...
class AggregatePoolInfoScheduleTest {
  ...
  @Mock
  AggregatePoolInfoRepository aggregatePoolInfoRepository;
  @Mock
  PoolHashRepository poolHashRepository;

  @Captor
  ArgumentCaptor<List<AggregatePoolInfo>> aggregatePoolInfoCaptor;
  AggregatePoolInfoSchedule aggregatePoolInfoSchedule;

  @BeforeEach
  void setUp() {
    aggregatePoolInfoSchedule = new AggregatePoolInfoSchedule(delegationService, blockRepository,
  ...
  void updateAggregatePoolInfoJobTest() {
    PoolHash poolHash1 = PoolHash.builder()
        .id(1L)
        .view("pool1q80jjs53w0fx836n8g38gtdwr8ck5zre3da90peuxn84sj3cu0r")
        .build();

    PoolHash poolHash2 = PoolHash.builder()
        .id(2L)
        .view("pool1ddskftmsscw92d7vnj89pldwx5feegkgcmamgt5t0e4lkd7mdp8")
        .build();

    PoolCountProjectionImpl pc1 =
        new PoolCountProjectionImpl(1L, "pool1q80jjs53w0fx836n8g38gtdwr8ck5zre3da90peuxn84sj3cu0r",
                                    10);

    PoolCountProjectionImpl pc2 =
        new PoolCountProjectionImpl(2L, "pool1ddskftmsscw92d7vnj89pldwx5feegkgcmamgt5t0e4lkd7mdp8",
                                    20);
    ...
    when(aggregatePoolInfoRepository.findAllByPoolIdIn(Set.of(1L, 2L)))

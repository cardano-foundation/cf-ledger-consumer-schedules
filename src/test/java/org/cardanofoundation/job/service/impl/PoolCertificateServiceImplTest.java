...
class PoolCertificateServiceImplTest {
  ...
  @BeforeEach
  void setUp() {
    poolCertificateService =
        new PoolCertificateServiceImpl(
            poolUpdateRepository, poolRetireRepository, new PoolCertificateMapperImpl());
  }

  @Test
  void getPoolCertificateByAction_shouldReturnCertificateRegistrationList() {
    PoolCertificateProjectionImpl certificateUpdate1 =
        PoolCertificateProjectionImpl.builder()
            .txId(1L)
            .txEpochNo(5)
            .certEpochNo(8)
            .certIndex(0)
            .poolUpdateId(1L)
            .blockTime(Timestamp.valueOf("2021-01-01 00:00:00"))
            .build();

    PoolCertificateProjectionImpl certificateUpdate2 =
        PoolCertificateProjectionImpl.builder()
            .txId(2L)
            .txEpochNo(6)
            .certEpochNo(8)
            .certIndex(0)
            .poolUpdateId(2L)
            .blockTime(Timestamp.valueOf("2021-02-01 00:00:00"))
            .build();
    PoolCertificateProjectionImpl certificateRetire1 =
        PoolCertificateProjectionImpl.builder()
            .txId(3L)
            .txEpochNo(7)
            .certEpochNo(9)
            .certIndex(0)
            .poolRetireId(1L)
            .blockTime(Timestamp.valueOf("2021-03-01 00:00:00"))
            .build();
    PoolCertificateProjectionImpl certificateUpdate3 =
        PoolCertificateProjectionImpl.builder()
            .txId(4L)
            .txEpochNo(11)
            .certEpochNo(14)
            .certIndex(0)
            .poolUpdateId(3L)
            .blockTime(Timestamp.valueOf("2021-04-01 00:00:00"))
            .build();
  ...
  void getPoolCertificateByAction_shouldReturnCertificateDeRegistrationList() {
    ...
    var response =
        poolCertificateService.getPoolCertificateByAction(
            poolViewOrHash, PoolActionType.POOL_DEREGISTRATION);

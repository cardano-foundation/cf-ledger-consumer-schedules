...
* add live pool delegators count schedule cache ([fac9316](https://github.com/cardano-foundation/cf-ledger-consumer-schedules/commit/fac93168a95a55d3be0af21126deccd77fc7538a))
...
* add migration agg_pool_info table ([45e4bf8](https://github.com/cardano-foundation/cf-ledger-consumer-schedules/commit/45e4bf866b421e1de8ccf5ee8ae714a1e165a522))
...
* add multi datasource configuration ([55fdd30](https://github.com/cardano-foundation/cf-ledger-consumer-schedules/commit/55fdd30c0ef21f6b6ab31c2e5e3496957da7561f))
...
* add new PoolInfoSchedule to aggregate pool info to redis cache ([bf9d191](https://github.com/cardano-foundation/cf-ledger-consumer-schedules/commit/bf9d191f71563802b8949cdf0d7647febc1268cd))
...
* Create licence checker and add to CICD pipeline for schedule ([7cd2d5e](https://github.com/cardano-foundation/cf-ledger-consumer-schedules/commit/7cd2d5ed3ac2fa91d908e04f81ef0bc71ea45e33))
...
* MET-1447 update report logic with multi datasource config ([dc01e26](https://github.com/cardano-foundation/cf-ledger-consumer-schedules/commit/dc01e26b3de97e733ce619b765466cbb78b27db9))
...
* MET-1532 remove hardcoded required logo bucket value in prod profile ([f4e0d1b](https://github.com/cardano-foundation/cf-ledger-consumer-schedules/commit/f4e0d1b94088f9ce564b2f11a5f01088e66f3692))
...
* MET-1737 update agg pool info job in explorer db ([0c574de](https://github.com/cardano-foundation/cf-ledger-consumer-schedules/commit/0c574de757e44051522ad0c8e6eb09ebeeb0501d))
* MEt-1738 migrate agg token info to explorer db ([1d3adf6](https://github.com/cardano-foundation/cf-ledger-consumer-schedules/commit/1d3adf6d6e61b5be86702dc0d934052f3bda5cda))
...
* update aggregate pool info schedule job ([45455c6](https://github.com/cardano-foundation/cf-ledger-consumer-schedules/commit/45455c62e601f8d644aa7e02b1f127bbccd5b0a2))
...
* update licenses.txt ([4a5083c](https://github.com/cardano-foundation/cf-ledger-consumer-schedules/commit/4a5083c4e491e0441a29b0e77178810f64cef96d))
* update licenses.txt ([c8df82d](https://github.com/cardano-foundation/cf-ledger-consumer-schedules/commit/c8df82d98c63f128f9649a49fec9764a3b1024a6))
...
* add enumeration and validation package to entityManager scan ([5f8f178](https://github.com/cardano-foundation/cf-ledger-consumer-schedules/commit/5f8f1787cfb0be86a6dabb86a22a6ecd13c7a2a4))
...
* rename "analytic" to "explorer" db source ([541a16e](https://github.com/cardano-foundation/cf-ledger-consumer-schedules/commit/541a16efdaebc28afc8be889bbce6908f9f0e0ae))

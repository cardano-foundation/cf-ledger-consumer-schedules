...
- LEDGER_SYNC_FLYWAY_ENABLED: Ledger-sync Migrate schema, set `true` if this is the first time run app
...
- ANALYTICS_FLYWAY_ENABLED: Analytics Migrate schema, set `true` if this is the first time run app
